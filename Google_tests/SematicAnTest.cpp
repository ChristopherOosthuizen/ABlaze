...
TEST(SematicAn, extends){
	ErrorThrower::hasError = false;
	delete ErrorThrower::errors;
	ErrorThrower::errors = new vector<string>();
	string main = "struct Place{ void read(){}} struct Pos extends Place{ void make(){read();} void write(){ make();}} void main(){ Pos pos = new Pos; pos.read();}";
	Lexer lexer(main);
	ASTGen gen = ASTGen(lexer.readAllTokens());
	Body* body = gen.generateAST();	
	SematicAn an(body);
...
TEST(SematicAn, stats){
	ErrorThrower::hasError = false;
	delete ErrorThrower::errors;
	ErrorThrower::errors = new vector<string>();
	string main = " struct Pos { static void mint(){println 12;} void read(){}} void main(){ Pos.mint(); Pos.read(); }";
	Lexer lexer(main);
	ASTGen gen = ASTGen(lexer.readAllTokens());
	Body* body = gen.generateAST();	
	SematicAn an(body);
...
TEST(SematicAn, extendss){
	ErrorThrower::hasError = false;
	delete ErrorThrower::errors;
	ErrorThrower::errors = new vector<string>();
	string main = " struct Pos extends Position{} void main(){}";
	Lexer lexer(main);
	ASTGen gen = ASTGen(lexer.readAllTokens());
	Body* body = gen.generateAST();	
	SematicAn an(body);
...
TEST(SematicAn, Private){
	ErrorThrower::hasError = false;
	delete ErrorThrower::errors;
	ErrorThrower::errors = new vector<string>();
	string main ="struct Name{ private int namer(){return 12;} int lake(){namer(); return  12;}}void main(){ Name n = new Name; n.namer();}";
	Lexer lexer(main);
	ASTGen gen = ASTGen(lexer.readAllTokens());
	Body* body = gen.generateAST();	
	SematicAn an(body);
...
TEST(SematicAn, classCalls){
	ErrorThrower::hasError = false;
	delete ErrorThrower::errors;
	ErrorThrower::errors = new vector<string>();
	string main ="struct Name{ int namer(){return 12;} int lake(){return namer(); }}";
	Lexer lexer(main);
	ASTGen gen = ASTGen(lexer.readAllTokens());
	Body* body = gen.generateAST();	
	SematicAn an(body);
